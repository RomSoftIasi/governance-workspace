                        ...
                        stage ('Customize build'){
                            container('node'){
                                stage ('Configure config-map'){
                                    ...
                                    sh 'cd $workspace/docker/k8s/templates && sed "s/%domain%/$domain/g" domains-configmap.yaml.template | sed "s/%subdomain%/$subdomain/g" | sed "s/%vaultdomain%/$vaultdomain/g" > domains-configmap.yaml'
